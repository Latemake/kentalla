...
function canPlay(match,id,index,rules=match.rotationRules) {
...
function initialLineup(mode,roster,rules={},template=null) {
...
function slotCoordinates(match,index) {
...
function moveSlot(match,index,x,y) {
...
function setSlotRole(match,index,pos) {
  const slot=match.slots[index];
